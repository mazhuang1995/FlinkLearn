...
public class KeyedProcessTopN {
    public static void main(String[] args) throws Exception {
        ...
        // 从自定义数据源读取数据
        SingleOutputStreamOperator<Event> enentStream = env
        ...
        SingleOutputStreamOperator<UrlViewCount> urlCountStream = enentStream
                .keyBy(data -> data.url)
    ...
    public static class TopN extends KeyedProcessFunction<Long, UrlViewCount, String> {
        ...
        public void processElement(UrlViewCount value, Context ctx, Collector<String> out) throws Exception {
            ...
            //注册window end + 1ms后的定时器，等待所有数据到齐后开始排序
        ...
        public void onTimer(long timestamp, KeyedProcessFunction<Long, UrlViewCount, String>.OnTimerContext ctx, Collector<String> out) throws Exception {
            ...
            ArrayList<UrlViewCount> urlViewCountArrayList = new ArrayList<UrlViewCount>();

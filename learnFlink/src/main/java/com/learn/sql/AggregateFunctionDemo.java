...
public class AggregateFunctionDemo {
    public static void main(String[] args) throws Exception {
        ...
        Table table = tableEnv.fromDataStream(scoreWeightDS, $("f0").as("name"), $("f1").as("score"), $("f2").as("weight"));
    ...
    /**
     * TODO 1.AggregateFunction<返回类型, 累加器类型<加权总和,权重总和>>
     */
    public static class WeightedAvg extends AggregateFunction<Double, Tuple2<Integer, Integer>> {

        @Override
        public Double getValue(Tuple2<Integer, Integer> accValue) {
            return accValue.f0 * 1D / accValue.f1;
        }
